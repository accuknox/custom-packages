...
# scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i $SSH_KEY ziggy@159.89.175.183:/home/ziggy/test/KubeArmor/KubeArmor/BPF/system_monitor.bpf.o  /tmp/system_monitor.bpf.o
