...
ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i $SSH_KEY 159.89.175.183 -C $SSH_COMMAND

scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i $SSH_KEY 159.89.175.183:/tmp/system_monitor.bpf.o /tmp/system_monitor.bpf.o
